...
CORS_ALLOWED_ORIGINS = tuple(
    ...
    for value in os.getenv(
        ...
        "http://localhost:3000,http://localhost:5173,http://127.0.0.1:5173,https://tesis-recurrentes-staking.anthonyjanampacalderon10.workers.dev,https://tesis-lstm-gru.anthonyjanampacalderon10.workers.dev",
    ).split(",")
    if value.strip()
)
